...
<ParamField body="query" param-type="string">
  `query` tells the API what you want to search.  In this case, you're telling the API you want to search by `categories`.  Any business that has `hotels` listed in its `categories` field will be returned.Example: "query": "categories:hotels"
