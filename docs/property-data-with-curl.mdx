...
<ParamField body="query" param-type="string" example='"query": "country:US"'>
...
<ParamField body="num_records" param-type="integer" example='"num_records": 1'>
  `num_records` tells the API how many records to return in its response.  In this case, you just want to see 1 matching record.
</ParamField>
<ParamField body="format" param-type="string" example='"format":"xxxx"'>
...
<Callout kind="alert">
  **Num_record not being specified**
...
<Image src="https://files.readme.io/b8b08d6f8ae5cdf1c77c8c56b6da899a6c006ce27fb76ddfb795aaf0a4f3b50b-image.png" width="1920" height="1080" alt="Screenshot showing open the csv file(s) in excel" noCaption />
