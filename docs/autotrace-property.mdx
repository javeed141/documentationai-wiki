...
Users can run Autotrace searches without extra query modifications. It's recommended to test different search parameters before running Autotrace as it will only return property data for records with `people.title:owner`.

### Request Parameters

<ParamField body="query" param-type="string" required="true">
  This selects which records should be matched. It's the same format as our search endpoint.
</ParamField>

<ParamField body="num_records" param-type="integer">
  The number of records matching the query you want to be updated. If this parameter is not specified, all matching records will be updated.
</ParamField>

<ParamField body="download" param-type="boolean">
  Set this to `true` or `false` to download the records to a file.
</ParamField>

<ParamField body="format" param-type="string">
  Specify either `"json"` or `"csv"` for your file format.
</ParamField>

<ParamField body="auto_trace" param-type="boolean" required="true">
  Set this to `true` or `false` for whether or not to autotrace the property records matched by your `query`.
</ParamField>

<ParamField body="only_traceable" param-type="boolean">
  Boolean `true` or `false` for whether the records returned must have people data in the dataset.
</ParamField>

<ParamField body="view" param-type="array">
  An array of field objects to customize which fields are returned. Each object requires a `name` and optionally supports `flatten` and `sub_fields`. For more information, see [Views](https://docs.datafiniti.co/docs/property-data-views).
</ParamField>

<Callout kind="info">
  **autotrace credits** Please note that autotrace API requests will require
  available property data credits and people data credits. Using an autotrace
  enabled search will charge 1 property data credit and 1 people data credit per
  `num_found` or set by `num_records`.
</Callout>
...
<ResponseField name="num_found" field-type="integer">
  The total number of records that matched your query.
</ResponseField>

<ResponseField name="total_cost" field-type="integer">
  The number of credits this request has cost you. Autotrace charges 1 property data credit and 1 people data credit per record.
</ResponseField>

<ResponseField name="records" field-type="array">
  The matching property records with appended people data. Each record contains the property fields and any traced owner contact information.
</ResponseField>
...
<Callout kind="info">
  **custom views** You can customize your view with as many or as little
  subfield as you would like. For more information you can read more about
  [Views](https://docs.datafiniti.co/docs/property-data-views).
</Callout>

<Callout kind="danger">
  **People data & views** Please note that you can NOT flatten `people` data
  sub-fields. People data that is appended via autotrace is already flattened
  for your convenience. If the `people.keys` is NOT found within a custom view,
  ...
  "records": [
    {
      ...
      "fees": [
        ...
        },
        {
          ...
          "amountMin": 507,
          "currency": "USD",
          "dateSeen": ["2022-03-15T16:18:00.000Z", "2022-04-07T10:10:00.000Z"],
          "type": "HOA"
        }
      ],
      "floorSizeValue": 2769,
      ...
      "hvacTypes": ["Ceiling Fan(s)", "Electric", "Central", "Central Air"],
      ...
      "mostRecentBrokerPhones": ["850-368-5782"],
      ...
      "numFloor": 3,
      "numUnit": 1,
      "parking": ["Garage Attached", "Deeded"],
      "parkingTypes": ["Attached Garage"],
      "postalCode": "32541",
      "prices": [
        {
          "amountMax": 440000,
          ...
          "availability": "false",
          "currency": "USD",
          "dateSeen": ["2020-08-21T21:11:11.089Z", "2020-08-21T20:19:44.214Z"],
      ...
      "propertyTaxes": [
        {
          "amount": 6152,
          "currency": "USD",
          "dateSeen": ["2018-01-01T00:00:00.000Z"]
        },
        {
          "amount": 5511,
          "currency": "USD",
          "dateSeen": ["2015-01-01T00:00:00.000Z"]
        }
      ],
      ...
      "people": [
        {
          ...
          "province": "FL",
          "sourceURLs": ["https://datafiniti.co/bd-datafiniti"],
          "tcpa": false,
