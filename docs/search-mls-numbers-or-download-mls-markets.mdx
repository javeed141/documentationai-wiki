...
<Callout kind="info">
  **MLS Searching** We recommend users combine their MLS number search with a
  province search for sometimes historical MLS data can be found that matches
  other MLSs in another state.
</Callout>
...
<Callout kind="alert">
  **Price & Integer Fields** please note your field's data type when inputting
  your value in the search query. price will not accept commas (,) in the value.
</Callout>
...
<Image
  src="https://files.readme.io/3dbcd1294d4b5dabf360c5d5a399cae34acf633aa217d354dbbd6b3f8d0e815d-image.png"
  alt=""
/>
