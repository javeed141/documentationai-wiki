...
<Image src="https://files.readme.io/3d5a5f8-1.jpg" alt='Click on "Search Property Data" to get started.' />

## 2. Setting the Stage

<Image src="https://files.readme.io/1ffc2eb-2.jpg" alt='Click on the "Body" tab and make sure you have "Raw" selected and that your text is set to "JSON(application/JSON)".' />

## 3. Running a Query

<Image src="https://files.readme.io/cf2aaa5-3.jpg" alt='The "Body" window will have 2 fields in it already. Hitting "Send" will query the Property Database for all records with a key.' />
...
<Image src="https://files.readme.io/496ee3c-7.jpg" alt={"If you'd like to create a custom view that you don't want to save, you can customize it inside the \"view\" field before running your query!"} />
...
<Image src="https://files.readme.io/dd71f9c-8.jpg" alt='When you send the request with a "download": true it will start downloading your files. You will need your download ID to access them, which you can find here.' />
