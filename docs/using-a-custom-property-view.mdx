...
This method will create a permanent view that you can declare by name in the view of your search body. Using the API endpoint you can create a view. We will use the previous fields as our view body. We will name this view `custom_transaction_view`.
...
Please note you can name the view any string value not currently used. To check your current view you can use:
</Callout>
