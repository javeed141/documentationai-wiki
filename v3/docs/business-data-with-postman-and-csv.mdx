...
| `records=1` | The `records` tells the API how many records to return in its response.  In this case, you just want to see 1 matching record. |
...
<Image src="https://files.readme.io/a7b5fae-hotel_sample.jpg" width="1920" height="1080" alt="Sample hotel business data output in Excel" noCaption />
