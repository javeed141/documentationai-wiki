...
<Columns cols="3">
  ...
  <Card title="products_basicFields" href="/v3/docs/products_basicfields" icon="file-text" horizontal="false">
    Returns a simplified set of core product data fields.
  </Card>

  <Card title="products_keysSourceURLs" href="/v3/docs/products_keyssourceurls" icon="link" horizontal="false">
  ...
  <Card title="products_reviewsFlat" href="/v3/docs/products_reviewsflat" icon="message-square" horizontal="false">
