...
We have updated our people data portal design to match the format inline with our property data page. This will allow for auto search names, easy to use filters, and one click common searches. Please try it out:
